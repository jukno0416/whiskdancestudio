...
<html>
<head>
<title>Whisk Dance studio |  :: Instructor Schedule</title>
...
{               ?>
							<div class="room1">
								...
								<div class="col-md-7 room-grid1">
									...
									<p>Day: <?php  echo htmlentities($row->MaxAdult);?></p>
									<p>Time: <?php  echo htmlentities($row->MaxChild);?></p>
									<p>Number: <?php  echo htmlentities($row->NoofBed);?></p>
									<p> Facilities: <?php  echo htmlentities($row->RoomFacility);?></p>
									<p>Price: <?php  echo htmlentities($row->Price);?></p>
									<button class="btn btn-success"><a href="book-room.php?rmid=<?php echo $row->rmid;?>">Join Now</a></button>
								</div>
