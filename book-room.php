...
$query->bindParam(':checkoutdate',$checkoutdate,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
   echo '<script>alert("Your Schedule has been book successfully. Booking Number is "+"'.$booknum.'")</script>';
...
<html>
<head>
<title>Whisk Dance Studio | :: Book Schedule</title>
...
{               ?>
								...
								<select  type="text" value="" class="form-control" name="idtype" required="true" class="form-control">
									<option value=""></option>
									<option value="GroupDance">GroupDance</option>
