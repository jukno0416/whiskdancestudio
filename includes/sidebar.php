    <div class="sidebar-menu">
                    <header class="logo1">
                      <span style="color:#000; font-size:26px; font-weight:bold; ">WDS</span>
                           ...
                           <div class="menu">
                                    <ul id="menu" >
                                        <li><a href="dashboard.php"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
                                         ...
                                         <li id="menu-academico" ><a href="#"><i class="lnr lnr-picture"></i> <span>Image</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="add-facility.php">Add Image</a></li>
                                            <li id="menu-academico-boletim" ><a href="manage-facility.php">Manage Image</a></li>

                                          </ul>



                                         <li id="menu-academico" ><a href="#"><i class="lnr lnr-camera-video"></i> <span>Video</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="add-facility.php">Add Video</a></li>
                                            <li id="menu-academico-boletim" ><a href="manage-facility.php">Manage Video</a></li>

                                          </ul>

                    

                                         <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Booking Category</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                           <ul id="menu-academico-sub" >
                                      ...
                                      <li id="menu-academico" ><a href="#"><i class="lnr lnr-pencil"></i> <span>New Schedule</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            <li id="menu-academico-avaliacoes" ><a href="add-room.php">Add Schedule</a></li>
                                            <li id="menu-academico-boletim" ><a href="manage-room.php">Manage Schedule</a></li>
